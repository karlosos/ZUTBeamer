...
\title{Projekt i implementacja aplikacji mobilnej o funkcjonalnościach wspomagających pracę muzyka-gitarzysty}
\date[\today]{\today}
\author[Działowski]{Artur Pieszak}
\city{Szczecin}
\institute[ZUT]{West Pomeranian University of Technology, Szczecin Poland}
\supervisor{mgr inż. Sławomir Wernikowski}
\goal{stworzenie aplikacji na system operacyjny android pozwalającej na używanie metronomu, stroika oraz notatnika na nuty z syntezatorem dźwięku.}
...
\section{Sec 2}
\begin{frame}[label=bibliography]{Sec 2}
  Test
\end{frame}
